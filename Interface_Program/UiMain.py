...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(1260, 840))
        MainWindow.setMaximumSize(QtCore.QSize(1260, 840))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Interface_Program/interface_image/icons/logo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label_show.setStyleSheet("border-image: url(Interface_Program/interface_image/icons/23.png);")
        ...
        self.groupBox.setGeometry(QtCore.QRect(0, 0, 431, 211))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(16)
        ...
        self.VideolineEdit.setGeometry(QtCore.QRect(70, 120, 311, 31))
        self.VideolineEdit.setObjectName("VideolineEdit")
        self.CamBtn = QtWidgets.QPushButton(self.groupBox)
        self.CamBtn.setGeometry(QtCore.QRect(30, 160, 30, 30))
        self.CamBtn.setStyleSheet("border-image: url(Interface_Program/interface_image/icons/camera.png);")
        self.CamBtn.setText("")
        self.CamBtn.setObjectName("CamBtn")
        self.ImgBtn = QtWidgets.QPushButton(self.groupBox)
        self.ImgBtn.setGeometry(QtCore.QRect(30, 40, 30, 30))
        self.ImgBtn.setStyleSheet("border-image: url(Interface_Program/interface_image/icons/img.png);")
        self.ImgBtn.setText("")
        self.ImgBtn.setObjectName("ImgBtn")
        self.VideoBtn = QtWidgets.QPushButton(self.groupBox)
        self.VideoBtn.setGeometry(QtCore.QRect(30, 120, 30, 30))
        self.VideoBtn.setStyleSheet("border-image: url(Interface_Program/interface_image/icons/video.png);")
        self.VideoBtn.setText("")
        self.VideoBtn.setObjectName("VideoBtn")
        self.CamlineEdit = QtWidgets.QLineEdit(self.groupBox)
        self.CamlineEdit.setGeometry(QtCore.QRect(70, 160, 311, 31))
        self.CamlineEdit.setObjectName("CamlineEdit")
        self.FileBtn = QtWidgets.QPushButton(self.groupBox)
        self.FileBtn.setGeometry(QtCore.QRect(30, 80, 30, 30))
        self.FileBtn.setStyleSheet("border-image: url(Interface_Program/interface_image/icons/folder.png);")
        self.FileBtn.setText("")
        self.FileBtn.setObjectName("FileBtn")
        self.FilelineEdit = QtWidgets.QLineEdit(self.groupBox)
        self.FilelineEdit.setGeometry(QtCore.QRect(70, 80, 311, 31))
        self.FilelineEdit.setObjectName("FilelineEdit")
        self.groupBox_2 = QtWidgets.QGroupBox(self.frame_4)
        self.groupBox_2.setGeometry(QtCore.QRect(0, 220, 431, 340))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(16)
        ...
        self.frame_6.setGeometry(QtCore.QRect(0, 170, 431, 171))
        ...
        self.lb_xmin = QtWidgets.QLabel(self.layoutWidget)
        ...
        self.lb_xmin.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.lb_xmin.setFont(font)
        self.lb_xmin.setText("")
        self.lb_xmin.setObjectName("lb_xmin")
        self.horizontalLayout.addWidget(self.lb_xmin)
        ...
        self.lb_ymin = QtWidgets.QLabel(self.layoutWidget1)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.WindowText, brush)
        self.lb_ymin.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.lb_ymin.setFont(font)
        self.lb_ymin.setText("")
        self.lb_ymin.setObjectName("lb_ymin")
        self.horizontalLayout_2.addWidget(self.lb_ymin)
        ...
        self.lb_xmax = QtWidgets.QLabel(self.layoutWidget2)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.WindowText, brush)
        self.lb_xmax.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.lb_xmax.setFont(font)
        self.lb_xmax.setText("")
        self.lb_xmax.setObjectName("lb_xmax")
        self.horizontalLayout_3.addWidget(self.lb_xmax)
        ...
        self.lb_ymax = QtWidgets.QLabel(self.layoutWidget3)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.WindowText, brush)
        self.lb_ymax.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.lb_ymax.setFont(font)
        self.lb_ymax.setText("")
        self.lb_ymax.setObjectName("lb_ymax")
        self.horizontalLayout_4.addWidget(self.lb_ymax)
        ...
        self.Combox = QtWidgets.QComboBox(self.layoutWidget5)
        self.Combox.setObjectName("Combox")
        self.horizontalLayout_6.addWidget(self.Combox)
        self.layoutWidget_2 = QtWidgets.QWidget(self.groupBox_2)
        self.layoutWidget_2.setGeometry(QtCore.QRect(10, 40, 185, 37))
        ...
        self.layoutWidget6.setGeometry(QtCore.QRect(210, 135, 210, 41))
        ...
        self.lb_conf = QtWidgets.QLabel(self.layoutWidget6)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.WindowText, brush)
        self.lb_conf.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.lb_conf.setFont(font)
        self.lb_conf.setText("")
        self.lb_conf.setObjectName("lb_conf")
        self.horizontalLayout_8.addWidget(self.lb_conf)
        self.layoutWidget_3 = QtWidgets.QWidget(self.groupBox_2)
        self.layoutWidget_3.setGeometry(QtCore.QRect(10, 135, 210, 41))
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(0, 569, 431, 132))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(16)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Interface_Program/interface_image/icons/保存.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.SaveBtn.setIcon(icon1)
        self.SaveBtn.setIconSize(QtCore.QSize(30, 30))
        self.SaveBtn.setObjectName("SaveBtn")
        self.WarnBtn = QtWidgets.QPushButton(self.groupBox_4)
        self.WarnBtn.setGeometry(QtCore.QRect(220, 50, 200, 51))
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("Interface_Program/interface_image/icons/退出.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.WarnBtn.setIcon(icon2)
        self.WarnBtn.setIconSize(QtCore.QSize(30, 30))
        self.WarnBtn.setObjectName("WarnBtn")
        ...
        self.label_3.setGeometry(QtCore.QRect(250, 0, 750, 51))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "基于深度学习的水体污染预警系统"))
        ...
        self.groupBox.setTitle(_translate("MainWindow", "上传文件"))
        ...
        self.FilelineEdit.setPlaceholderText(_translate("MainWindow", "请选择文件夹"))
        self.CamlineEdit.setPlaceholderText(_translate("MainWindow", "摄像头未开启"))
        ...
        self.WarnBtn.setText(_translate("MainWindow", "查看预警信息"))
        self.label_3.setText(_translate("MainWindow", "基于深度学习的水体污染预警系统"))
        #self.label_2.setText(_translate("MainWindow", "版权所有：KAI工作室"))
